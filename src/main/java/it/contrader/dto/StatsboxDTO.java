...
public class StatsboxDTO implements DTO {
		...
		public StatsboxDTO(int id, int playerId, int season, int caps, float contributions, float shotsper,
		...
		public StatsboxDTO(int playerId, int season, int caps, float contributions, float shotsper,
				float keypass, float passprec, float dribbling, float foulssub, float foulscomm, float tackles,
				float tacklesper, float breaks) {
			super();
			this.playerId = playerId;
