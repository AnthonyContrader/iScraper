...
<body>
	...
	<br>
		...
		<tr>
			<td> <a href=StatsboxServlet?mode=read&update=true&id=<%=d.getId() %>> <input type=button class="statstable" value="NEW"></a></td>
			<td> <a href=StatsboxServlet?mode=delete&id=<%=d.getId()%>> <input type=button class="statstable" value="X"></a></td>
